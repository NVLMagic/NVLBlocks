...
public class NVLHoloSignScreen extends AbstractContainerScreen<NVLHoloSignMenu> implements NVLInterfaceLogger {
	protected static ResourceLocation CONTAINER_BACKGROUND =
			new ResourceLocation(NVLBlocks.MODID, "textures/gui/hs.png");
	protected int SIZEX = 256;
	protected int SIZEY = 90;
//	protected int SHIFTY = 8;
	protected static final Component TITLE = Component.translatable("gui." + NVLBlocks.MODID + ".nvl_hs_screen");
	public NVLHoloSignScreen(NVLHoloSignMenu pMenu, Inventory pPlayerInventory, Component pTitle) {
